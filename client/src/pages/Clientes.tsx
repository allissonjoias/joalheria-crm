        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <select value={form.tipo_interesse} onChange={(e) => setForm({...form, tipo_interesse: e.target.value})} className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-alisson-400">
            ...
            <div>
              ...
              <select value={form.ocasiao} onChange={(e) => setForm({...form, ocasiao: e.target.value})} className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-alisson-400">
                <option value="">Selecionar</option>
          ...
          <div>
            ...
            <textarea value={form.notas} onChange={(e) => setForm({...form, notas: e.target.value})} className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-alisson-400" rows={3} />
          </div>
        ...
        {clienteSelecionado && (
          <div>
            <div className="grid grid-cols-2 gap-4 mb-6">
              ...
              <div><p className="text-xs text-gray-500">Ocasiao</p><p className="text-sm font-medium">{clienteSelecionado.ocasiao || '-'}</p></div>
            ...
            <h4 className="font-semibold text-alisson-600 mb-3">Historico de Interacoes</h4>
            <div className="space-y-3 max-h-64 overflow-y-auto">
              ...
              {interacoes.length === 0 && <p className="text-gray-400 text-sm">Nenhuma interacao registrada</p>}
            </div>
          </div>
        )}
      </Modal>
